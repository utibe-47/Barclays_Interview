...
class ThinkfolioPositions(Base):
    __tablename__ = 'thinkfolio_positions'
    ...
    Tenor = db.Column(db.String(255))
    PositionTarget = db.Column(db.Float(), default=0.0)
    Protection = db.Column(db.String(255))
    Account = db.Column(db.String(255))
    Strategy = db.Column(db.String(255))
    DealingDesk = db.Column(db.String(255))
    InstrumentType = db.Column(db.String(255))
    Strike = db.Column(db.String(255))
    ReasonCode = db.Column(db.String(255))
